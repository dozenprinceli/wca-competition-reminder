...
const TRANSLATIONS = {
  zh: {
    ...
    registerTitle: "注册邮件提醒",
    registerDescription: "验证邮箱，设置你的比赛提醒范围。",
    registerSubmit: "建立提醒",
    registerEmailHint: "该邮箱将作为订阅的唯一标识",
    ...
    consentRequired: "注册前请勾选同意接收 WCA 比赛通知邮件。",
  ...
  en: {
    pageTitle: "WCA Competition Reminder | Email Subscription",
    subscriptionOperations: "Subscription controls",
    brandName: "Competition Desk",
    ...
    railFootCopy: "Receive only the competitions you care about. Your email is the sole subscription key, and preferences can change anytime.",
    heroLine1: "Keep the next",
    heroLine2: "competition in view.",
    ...
    consent: "I agree to receive WCA competition emails",
    ...
    registerKicker: "NEW CHANNEL",
    registerTitle: "Subscribe to reminders",
    registerDescription: "Verify your email and set the competitions you want to follow.",
    registerSubmit: "Create reminder",
    registerEmailHint: "This email becomes the unique key for your subscription",
    modifyKicker: "EDIT CHANNEL",
    modifyTitle: "Edit reminder preferences",
    ...
    cancelKicker: "CLOSE CHANNEL",
    cancelTitle: "Cancel email reminders",
    ...
    consentRequired: "Agree to receive WCA competition emails before subscribing.",
